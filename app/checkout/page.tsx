...
import { ArrowLeft, CheckCircle2, ShieldCheck, ShoppingBag, Lock, CreditCard } from "lucide-react";
import { useCart } from "@/lib/cart-context";
import { formatPrice } from "@/lib/utils";

type PaymentMethodType = "card" | "paypal" | "applepay" | "googlepay";
        ...
        <div className="space-y-3">
          ...
          {confirmedPaymentLabel && (
            <p className="text-xs text-neutral-500">
              Payment Method: <span className="text-black font-semibold">{confirmedPaymentLabel}</span>
            </p>
          )}
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="p-6 sm:p-8 rounded-3xl border border-neutral-200 bg-white space-y-5">
            <div className="flex items-center justify-between pb-1 border-b border-neutral-100">
              <div>
                <h2 className="font-bold text-lg text-black">Payment Method</h2>
                <p className="text-xs text-neutral-500 mt-0.5">Select your preferred payment method</p>
              </div>
              <span className="text-[11px] font-medium text-neutral-500 flex items-center gap-1.5 bg-neutral-50 px-2.5 py-1 rounded-full border border-neutral-200/60">
            ...
            <div className="space-y-3">
              ...
              >
                ...
                {/* If card is selected, show realistic card fields */}
                {paymentMethod === "card" && (
                    ...
                    <div>
                      ...
                      <div className="relative flex items-center">
                        <input
                          ...
                          maxLength={19}
                          className="w-full px-4 py-2.5 bg-[#F0F0F0] rounded-xl text-sm font-mono text-black outline-none focus:ring-1 focus:ring-black pr-24"
                        />
                        <div className="absolute right-3 flex items-center gap-1.5 pointer-events-none">
                          <span className="text-[10px] uppercase font-bold tracking-wider text-neutral-400">
                            {cardDetails.number.replace(/\s/g, "").startsWith("5") ? "Mastercard" : "Visa"}
                          </span>
                        </div>
                      </div>
                    </div>
              ...
              >
                ...
                {paymentMethod === "paypal" && (
                  <div className="mt-3.5 pt-3.5 border-t border-neutral-200 text-xs text-neutral-600 animate-in fade-in duration-200 space-y-1">
                    <p>Pay quickly and securely with your PayPal account or PayPal Credit.</p>
                    <p className="text-[11px] text-neutral-400">You will be verified in instant simulated sandbox mode.</p>
                  </div>
                )}
              </div>
              ...
              >
                ...
                {paymentMethod === "applepay" && (
                  <div className="mt-3.5 pt-3.5 border-t border-neutral-200 text-xs text-neutral-600 animate-in fade-in duration-200 space-y-1">
                    <p>Express 1-touch checkout with Apple Pay.</p>
                    <p className="text-[11px] text-neutral-400">Authentication simulated via biometric Apple Pay wallet.</p>
                  </div>
                )}
              </div>
              ...
              >
                ...
                {paymentMethod === "googlepay" && (
                  <div className="mt-3.5 pt-3.5 border-t border-neutral-200 text-xs text-neutral-600 animate-in fade-in duration-200 space-y-1">
                    <p>Pay quickly with payment methods saved to your Google Account.</p>
                    <p className="text-[11px] text-neutral-400">Encrypted instant checkout simulation.</p>
                  </div>
                )}
              </div>
            </div>
