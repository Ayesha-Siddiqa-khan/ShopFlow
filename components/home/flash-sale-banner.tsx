        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-white text-xs font-semibold backdrop-blur-xs">
              ...
              <span>LIMITED VIP AUTUMN DROP</span>
            </div>
          ...
          <div className="lg:col-span-5 flex flex-col items-center lg:items-end justify-center space-y-6">
            ...
            <div className="flex items-center gap-3">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center justify-center font-integral text-2xl sm:text-3xl text-white shadow-inner">
                  {pad(timeLeft.hours)}
                </div>
                <span className="text-[11px] text-neutral-400 uppercase tracking-wider mt-1.5 font-medium">Hours</span>
              </div>

              <span className="font-integral text-2xl text-neutral-500 -mt-5">:</span>
              ...
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md flex items-center justify-center font-integral text-2xl sm:text-3xl text-orange-400 shadow-inner">
                  {pad(timeLeft.seconds)}
                </div>
                <span className="text-[11px] text-neutral-400 uppercase tracking-wider mt-1.5 font-medium">Seconds</span>
              </div>
            </div>

            <Link
              href="/products"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-white text-black font-semibold text-sm hover:bg-neutral-100 transition-all hover:scale-105 shadow-lg group"
            >
